\begin{table}[tbp]
\centering
\caption{Paired SDA--baseline recall differences on three candidate pools, Qwen3-8B. Entries are seed-averaged differences in points with 95\% intervals from 4,000 paired bootstrap draws over episodes. The provenance-cued wording explicitly permits a useful concept the passage never mentions. All comparisons use the same frozen reader and blind semantic judge.}
\label{tab:paired}
\small
