\begin{table*}[t]
\centering
\caption{Recall accuracy (\%) across models on the held-out Fresh-2 battery
(363 episodes) with $k$ stored concepts, blind semantic grading.
Rating: 1--10 importance rating \citep{park2023generative}; SDA:
mean of three seeds. $^{*}$every seed exceeds the same model's yes/no
report at that budget (exact McNemar $p<0.05$).}
\label{tab:sdabudget}
\small
