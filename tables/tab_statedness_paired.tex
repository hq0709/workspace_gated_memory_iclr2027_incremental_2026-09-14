\begin{table*}[t]
\centering
\caption{Paired SDA minus baseline recall differences for every row of
Table~\ref{tab:balancedbaselines}, statedness-balanced pool, Qwen3-8B.
Three-seed means in percentage points; 95\% intervals from 4,000
paired bootstrap draws over 363 episodes. Published methods:
1--10 importance rating \citep{park2023generative}; ConsistencyGate
\citep{consistencygate2026}; A-MAC \citep{amac2026}; prediction error
\citep{nemori2026}.}
