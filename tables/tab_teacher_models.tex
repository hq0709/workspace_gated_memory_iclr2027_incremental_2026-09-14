\begin{table*}[t]
\centering
\caption{Teacher composition on the statedness-balanced pool for five models.
Recall in percent, averaged over three training seeds per teacher.
Reduced columns: students of SDA's teacher with one signal removed.
Table~\ref{tab:teachermodelpaired} gives paired differences.}
