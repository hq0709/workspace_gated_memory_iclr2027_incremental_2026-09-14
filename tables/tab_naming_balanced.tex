\begin{table*}[t]
\centering
\caption{Candidate ranking and useful-concept retention on the naming-balanced
pool, Qwen3-8B, 363 episodes and 2,877 candidates. AUC uses
construction utility labels; retention is in percent.}
