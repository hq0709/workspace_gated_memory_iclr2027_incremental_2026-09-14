\begin{table*}[t]
\centering
\caption{Admission ranking on the Decoupled and Compositional development
batteries across Qwen3 scales. $V$: pooled admission AUC; $\Delta V$:
paired change with a 95\% whole-episode bootstrap interval;
$|\Delta W|$: largest absolute workspace change across seeds.}
\label{tab:sdascale}
\small
