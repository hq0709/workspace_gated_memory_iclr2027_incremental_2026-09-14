\begin{table*}[t]
\centering
\caption{Recall on the naming-balanced pool, 363 episodes and six models,
at one, two and three stored concepts; blind semantic grading,
percent. Report: each model's own yes/no importance report; Rating:
1--10 importance rating \citep{park2023generative}; SDA: mean of
three seeds.}
