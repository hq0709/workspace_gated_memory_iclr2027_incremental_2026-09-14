\begin{table*}[t]
\centering
\caption{SDA ablations on the standard Fresh-2 pool (Qwen3-8B, $k=2$,
blind semantic recall in percent). Trained variants average three
seeds. $\Delta$: recall difference from SDA with a paired,
seed-averaged 4,000-draw episode bootstrap 95\% interval.}
