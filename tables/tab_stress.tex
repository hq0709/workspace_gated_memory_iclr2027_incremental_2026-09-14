\begin{table*}[t]
\centering
\caption{Recall on the pool with unstated distractors (Fresh-2,
8.4 candidates per episode). Blind semantic grading, recall in
percent, three training seeds per model; $p$ bounds the exact McNemar
test against each model's own yes/no report across those seeds.}
\label{tab:stress}
\small
