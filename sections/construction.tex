...
\textbf{Answer.} arabic.
\end{sdabox}
\caption{A complete Fresh-2 episode. The passage identifies a landmark
from which the city can be inferred. Retaining \emph{dubai} preserves
the city-to-language link needed by the future question. Utility labels,
question and answer are visible here for explanation; admission sees
the passage and candidate strings.}
\label{fig:episode}
\end{figure}
