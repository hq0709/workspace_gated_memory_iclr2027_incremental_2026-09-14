...
Recall measures the downstream effect of admission for a fixed reader:
it is the fraction of future questions answered correctly from stored
concepts by the frozen reader. A policy can rank the bridge
